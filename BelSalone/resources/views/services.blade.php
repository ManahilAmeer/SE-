            ...
            <div class="col-md-3" style="margin-bottom:20px">
                <div class="card p-2 py-3 text-center">
                    ...
                    <div class="mt-4 apointment">
                        <button onclick="window.location.href='/reviews'" class="btn btn-success text-uppercase">Read Reviews</button>
                        <button onclick='GetData();' class="btn btn-success text-uppercase">Book Appointment</button>
                    </div>
                </div>
            </div>
{{-- Card 1 ending and I haven't customized the others because we'll be using for loop for the first one and load into its template --}}
    ...
    function GetData(){
        ...
        //alert(serviceName);
        window.location.href = "/booking?beautName=" + beautName + "&Price=" + Price + "&serviceName=" + serviceName;
    }
    </script>
</body>
</html>
