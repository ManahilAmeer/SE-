...
<div style="width: 100%" class="flex-container">
    <div class="sidebar">
        <div class="container-fluid" style="display:block; box-sizing: border-box; width: 100%; height: 30%; border-bottom: 2px solid #e75480; background-color: pink; padding-top:30px; padding-bottom:30px;">
            ...
            <h3 align="center" style="color: #e75480; font-weight: 700; padding-top: 10px">Beautician Name</h3>
        </div>
